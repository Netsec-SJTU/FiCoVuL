...
parser.add_argument("--xfile", type=str, default="graph_reprs.npy", help="file name of feature stored")
parser.add_argument("--yfile", type=str, default="labels.npy", help="file name of label stored")
...
if __name__ == "__main__":
    ...
    X = np.load(xfile)
    X = torch.Tensor(X)
    labels = np.load(yfile).squeeze().tolist()
